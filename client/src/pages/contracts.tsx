...
export default function ContractsPage() {
  ...
  const handleCopyToCreateDialog = () => {
    ...
    setFormData({
      ...
      paymentConfirmed: sourceContract.paymentConfirmed || false,
      paymentMethod: normalizePaymentMethodForForm(sourceContract.paymentMethod),
      depositBank: normalizeDepositBankForForm(
        (sourceContract as Contract & { depositBank?: string | null }).depositBank,
        sourceContract.paymentMethod,
      ),
